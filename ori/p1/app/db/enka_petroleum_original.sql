...
CREATE TABLE IF NOT EXISTS `bols` (
  ...
  `vendor_fk` smallint(6) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bol_details` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `bol_fk` int(11) unsigned NOT NULL,
  `product_fk` smallint(6) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `carrier_split_charges` (
  `carrier_fk` tinyint(3) unsigned NOT NULL,
...
INSERT INTO `carrier_split_charges` (`carrier_fk`, `straight`, `two_way`, `three_way`, `four_way`) VALUES
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `notes` text NOT NULL,
  `group_fk` mediumint(6) DEFAULT NULL,
...
INSERT INTO `customers` (`id`, `_login`, `_pass`, `pricing_level`, `name`, `address`, `phone`, `fax`, `balance`, `owner_name`, `owner_mobile`, `owner_email`, `tank_capacity`, `notes`, `group_fk`, `active`, `created`) VALUES
...
CREATE TABLE IF NOT EXISTS `invoice_bols` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `invoice_fk` int(10) unsigned NOT NULL,
  `bol_fk` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `invoice_fk` (`invoice_fk`),
  KEY `bol_fk` (`bol_fk`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `customer_fk` int(10) unsigned NOT NULL,
  `terminal_fk` tinyint(3) unsigned DEFAULT NULL,
  `carrier_fk` tinyint(4) unsigned DEFAULT NULL COMMENT '1 = Kittery, 2 = CBC, 3 = EBC, 4 = Mystic',
...
INSERT INTO `orders` (`id`, `status`, `customer_fk`, `terminal_fk`, `carrier_fk`, `zone`, `split`, `requested_delivery_time`, `actual_delivery_time`, `created`) VALUES
...
CREATE TABLE IF NOT EXISTS `order_details` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_fk` int(11) unsigned NOT NULL,
  `vendor_fk` smallint(6) unsigned DEFAULT NULL,
  `product_fk` smallint(6) unsigned NOT NULL,
  `product_quantity` smallint(6) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `order_fk` (`order_fk`),
...
INSERT INTO `order_details` (`id`, `order_fk`, `vendor_fk`, `product_fk`, `product_quantity`) VALUES
(1, 1, 1, 1, 6500),
(2, 2, 4, 1, 3500),
(3, 3, 4, 1, 4900),
(4, 4, 4, 1, 4100),
...
CREATE TABLE IF NOT EXISTS `order_splits` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_fk` int(11) unsigned NOT NULL,
  `split_order_fk` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `order_fk` (`order_fk`),
  KEY `split_order_fk` (`split_order_fk`)
...
INSERT INTO `order_splits` (`id`, `order_fk`, `split_order_fk`) VALUES
(1, 2, 3),
(2, 2, 4),
(3, 3, 2),
(4, 3, 4),
...
CREATE TABLE IF NOT EXISTS `prices` (
  ...
  `terminal_fk` smallint(5) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `vendor_fk` (`vendor_fk`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
ALTER TABLE `bol_details`
  ADD CONSTRAINT `bol_details_ibfk_1` FOREIGN KEY (`bol_fk`) REFERENCES `bols` (`bol_no`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `bol_details_ibfk_2` FOREIGN KEY (`product_fk`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `carrier_split_charges`
--
ALTER TABLE `carrier_split_charges`
  ADD CONSTRAINT `carrier_split_charges_ibfk_1` FOREIGN KEY (`carrier_fk`) REFERENCES `carriers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `customers`
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`group_fk`) REFERENCES `groups` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `efts`
--
ALTER TABLE `efts`
  ADD CONSTRAINT `efts_ibfk_1` FOREIGN KEY (`vendor_fk`) REFERENCES `vendors` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `eft_bols`
--
ALTER TABLE `eft_bols`
  ADD CONSTRAINT `eft_bols_ibfk_1` FOREIGN KEY (`eft_fk`) REFERENCES `efts` (`eft_no`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `eft_bols_ibfk_2` FOREIGN KEY (`bol_fk`) REFERENCES `bols` (`bol_no`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `invoices`
--
ALTER TABLE `invoices`
  ADD CONSTRAINT `invoices_ibfk_1` FOREIGN KEY (`order_fk`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `invoices_ibfk_2` FOREIGN KEY (`customer_fk`) REFERENCES `customers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `invoices_ibfk_3` FOREIGN KEY (`carrier_fk`) REFERENCES `carriers` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `invoice_bols`
--
ALTER TABLE `invoice_bols`
  ADD CONSTRAINT `invoice_bols_ibfk_2` FOREIGN KEY (`bol_fk`) REFERENCES `bols` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `invoice_bols_ibfk_1` FOREIGN KEY (`invoice_fk`) REFERENCES `invoices` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `invoice_details`
--
ALTER TABLE `invoice_details`
  ADD CONSTRAINT `invoice_details_ibfk_2` FOREIGN KEY (`product_fk`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `invoice_details_ibfk_1` FOREIGN KEY (`invoice_fk`) REFERENCES `invoices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`customer_fk`) REFERENCES `customers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`terminal_fk`) REFERENCES `terminals` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`carrier_fk`) REFERENCES `carriers` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `order_details`
--
ALTER TABLE `order_details`
  ADD CONSTRAINT `order_details_ibfk_1` FOREIGN KEY (`order_fk`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`vendor_fk`) REFERENCES `vendors` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `order_details_ibfk_3` FOREIGN KEY (`product_fk`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `order_splits`
--
ALTER TABLE `order_splits`
  ADD CONSTRAINT `order_splits_ibfk_1` FOREIGN KEY (`order_fk`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `order_splits_ibfk_2` FOREIGN KEY (`split_order_fk`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `prices`
--
ALTER TABLE `prices`
  ADD CONSTRAINT `prices_ibfk_1` FOREIGN KEY (`vendor_fk`) REFERENCES `vendors` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `trucking_details`
--
ALTER TABLE `trucking_details`
  ADD CONSTRAINT `trucking_details_ibfk_2` FOREIGN KEY (`invoice_fk`) REFERENCES `invoices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
